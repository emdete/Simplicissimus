...
public class Meta implements Iterator<TheDictionary>, Iterable<TheDictionary> {
	...
	static String phone_type_text(int i) {
		...
		case TelephonyManager.PHONE_TYPE_SIP: return "PHONE_TYPE_SIP";
		default: return "PHONE_TYPE_" + i;
		}
	}
	...
	static String data_activity_text(int i) {
		...
		default: return "DATA_ACTIVITY_" + i;
		}
	}
	...
	static String network_type_text(int i) {
		...
		case TelephonyManager.NETWORK_TYPE_EHRPD: return "NETWORK_TYPE_EHRPD";
		...
		case TelephonyManager.NETWORK_TYPE_EVDO_B: return "NETWORK_TYPE_EVDO_B";
		...
		case TelephonyManager.NETWORK_TYPE_HSPAP: return "NETWORK_TYPE_HSPAP";
		case TelephonyManager.NETWORK_TYPE_HSUPA: return "NETWORK_TYPE_HSUPA";
		case TelephonyManager.NETWORK_TYPE_IDEN: return "NETWORK_TYPE_IDEN";
		case TelephonyManager.NETWORK_TYPE_LTE: return "NETWORK_TYPE_LTE";
		...
		default: return "NETWORK_TYPE_" + i;
		}
	}
	...
	static public String test(Context context) {
		List<TheDictionary> arr = new ArrayList<TheDictionary>();
		int post17cells = 0;
		int pre17cells = 0;
		int gps = 0;
		int wlans = 0;
