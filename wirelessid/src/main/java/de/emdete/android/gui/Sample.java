...
import de.emdete.android.wirelessid.Meta;
...
public class Sample extends Activity {
	...
	public void doTest(Context context) {
		Button button = (Button)findViewById(R.id.button);
		button.setText(Meta.test(context));
		//button.setText(WirelessLanCid.test(context));
		//button.setText(PreApi17Cid.test(context));
		//button.setText(PostApi17Cid.test(context));
	}
}
